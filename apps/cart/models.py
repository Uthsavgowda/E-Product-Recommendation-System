...
class Product(models.Model):
    ...
    gender_cat = models.CharField(max_length=200,null=True)
    sub_cat = models.CharField(max_length=200,null=True)
    articel_type = models.CharField(max_length=200,null=True)
    market_price = models.PositiveIntegerField(default=0)
    discount_price = models.PositiveIntegerField(default=0)
    description = models.TextField()
    new_product_url = models.URLField(max_length=2000,blank=True)
    ...
    ama_market_price = models.PositiveIntegerField(default=0)
    ama_discount_price = models.PositiveIntegerField(default=0)
    ama_rating = models.FloatField(null=True)
    # ama_url = models.URLField(max_length=2000,blank=True)
